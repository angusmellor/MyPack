...
var addItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var args, requiredArgs, response, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                args = ['nameId', 'categoryId', 'description', 'weight'];
                requiredArgs = args.reduce(function (acc, curr) {
...
var getAllItems = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, items_1.itemModel.getAllItems()];
            case 1:
                response = _a.sent();
                res.status(201);
                res.send(response);
...
exports.itemController = { addItem: addItem, getAllItems: getAllItems };
